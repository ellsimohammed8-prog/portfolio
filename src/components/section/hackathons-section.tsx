      ...
      <div className="flex min-h-0 flex-col gap-y-8 w-full">
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">Competitions & Innovation</h2>
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              Throughout my academic and engineering journey, I have actively participated in regional innovation challenges and hackathons, transforming concepts into functional IoT, AI, and bioprocess prototypes.
            </p>
          </div>
        </div>
        <Timeline>
